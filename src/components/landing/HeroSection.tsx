...
export const HeroSection = () => {
  return (
    <section className='relative px-4 py-20 overflow-hidden sm:px-6 lg:px-8'>
      {/* Background gradient */}
      <div className='absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-transparent dark:from-blue-500/5 dark:via-purple-500/5'></div>
        ...
        <div className='grid items-center gap-12 lg:grid-cols-2'>
          ...
          <div className='space-y-8'>
            ...
            <div className='flex flex-col gap-4 sm:flex-row'>
              <Link
                to='/register'
                className='inline-flex items-center justify-center px-8 py-4 font-medium text-white transition-all duration-300 rounded-lg shadow-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:shadow-xl group'
              >
                Get Started Free
