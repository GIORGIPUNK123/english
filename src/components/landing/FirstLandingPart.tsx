...
export const FirstLandingPart = () => {
  return (
    <div
      className='flex flex-col items-center w-full mt-44 md:flex-row'
      id='home'
    >
      <div className='flex items-center justify-center w-full md:w-1/2'>
        <div
          className=' mt-12 ml-12 w-full max-w-[300px] sm:max-w-[600px] h-96  bg-center bg-cover rounded-lg -rotate-6 mr-6'
